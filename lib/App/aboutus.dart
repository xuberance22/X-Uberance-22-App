                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children:[
                          ...
                          Text("ST. XAVIER'S COLLEGIATE SCHOOL",textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontFamily: 'Xavier1', fontSize: 0.04625 * width)),
                          Divider(
                            color: Colors.white,
                            indent: 0,
                            endIndent: 0,
                          ...
                          Padding(
                            ...
                            child: Text("""In November, 1843, a fire broke out in San Souci Theatre, no. 10 Park Street, Kolkata. It was an accident that changed the history of Park Street and that of “The City of Joy”, Kolkata as well. Fire is indeed a destroyer but is also a purifier that gets rid of the “old” and creates something new. 
                                \n\nThe fire that destroyed the San Souci Theatre on that day rekindled another fire-“The Fire of Education”. Eventually that burnt out theatre became the home of an institution that redefined modern education. A small band of Belgium Jesuits headed by Father Henry Depelchin opened their hearts and the doors of their abode at 10, Park Street(Now 30, Mother Teresa Sarani) to become what today stands as a symbol of quality education in the country… 
                                \nSt. Xavier’s Collegiate School, Kolkata.
                                \n\nAfter 162 years since its opening, St. Xaviers’s Collegiate School still is and will be an inspiration of an organisation for all. Respecting and displaying proper edicate has been a major part of Xaverian culture and it is one that all future generations look to uphold. 
                          ...
                          //   ),
                          // ),
                           Text("ABOUT X-UBERANCE", style: TextStyle(color: Colors.white, fontFamily: 'Xavier1', fontSize: 0.04625 * width)),
                          Divider(
                            color: Colors.white,
                            indent: 0,
                            endIndent: 0,
