...
List SportingDay1 = ["X-GOAL", "X-PULL", "X-HOOP", "X-PONG"];
List SportingDay2 = ["X-GOAL", "X-WICKET", "X-MATE", "X-PULL", "X-O☐Δ"];
List SportingDay3 = ["X-SPIKE"];
List OffStageDay1 = [
  "X-Calibre",
  "X-GAANA",
  "X-30",
...
List OffStageDay3 = ["X-CALIBRE", "X-BID", "X-HUNT", "X-CODE"];
List OnStageDay1 = ["X-ABHINOY", "X-HOP", "X-DROP", "X-60", "X-VOGUE"];
List OnStageDay2 = ["X-RHYME", "X-PUN", "X-RAGA", "X-ACOUSTIC"];
List OnStageDay3 = ["X-ACT", "X-TRAVAGANCE"];
...
List<Eventss> Sporting = [
  Eventss(
      ...
      location: "BACK  FIELD",
      day: "1-2",
      time: "12:30(Day 1), 8:30(Day 2)",
      participants: "7+3 (SUBSTITUTES)",
      phrase: "SIIUUU!",
      rules:
      """Football is a game involving two teams who try to manoeuvre the ball into the other team's goal..
...
""",
      link: "images/X-GOAL.png",
      guidelines: """Venue: St. Xavier's Collegiate School, Kolkata
...
\n9. Rights to admission are reserved.""",
  mapLink: 'lib/Event_Location/X-GOAL.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-HOOP",
      about: "BASKETBALL",
      category: "SPORTING",
      ...
      rules:
      """Basketball is a team sport in which two teams compete with the objective of shooting a basketball through the defender's hoop, while preventing the opposing team from shooting through their own hoop.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-HOOP.png',
  floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-PONG",
      about: "TABLE TENNIS",
      ...
      rules:
      """Table tennis, also known as ping-pong, is a sport in which two or four players hit a lightweight ball, also known as the ping-pong ball, back and forth across a table using small solid rackets. The game takes place on a hard table divided by a net.
...
\n9. Rights to admission are reserved.""",
    ...
    mapLink: 'lib/Event_Location/X-PONG.png',
      floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-SPIKE",
      about: "VOLLEYBALL",
      ...
      time: "8:30",
      participants: "9",
      phrase: "Can’t let the ball bounce.",
      rules:
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-SPIKE.png',
      floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-PULL",
      about: "TUG OF WAR",
      ...
      day: "1-2",
      time: "12:30(Day 1), 9:00(Day 2)",
      participants: "12",
      phrase: "AA dekhe zara kismein kitna hai dum",
      rules:
...
\n9. Rights to admission are reserved.""",
    ...
    mapLink: 'lib/Event_Location/X-PULL.png',
floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-MATE",
      about: "CHESS",
      ...
      rules:
      """Chess is a board game played between two players.. The current form of the game emerged in Spain and the rest of Southern Europe during the second half of the 15th century after evolving from chaturanga, a similar but much older game of Indian origin.
...
\n9. Rights to admission are reserved.""",
    ...
    mapLink: 'lib/Event_Location/X-MATE.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-WICKET",
      about: "BOX CRICKET",
      category: "SPORTING",
      ...
      time: "8:30",
      participants: "13",
      phrase: "Mera bat, Mein batting karunga - This is an emotion",
      rules:
      """Indoor cricket or box cricket involves two teams with 6-8 players each playing in a closed space, usually a net-covered turf. Most matches are played within an hour's time frame with rules set before the game or tournament.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-WICKET.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-O☐Δ",
      about: "FIFA",
      category: "SPORTING",
      ...
      time: "9:00",
      participants: "1+1",
      phrase: "EA SPORTS IT'S IN THE GAME!",
      rules:
      """Fifa is a popular Esports game played throughout the world. It has special rights purchased by EA which allows it to retain its name, which is kept after the biggest football tournament; Fifa World Cup.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-O☐Δ.png',floor: 'FIRST FLOOR'),
];
...
List<Eventss> OffStage = [
  Eventss(
      ...
      time: "1:00",
      participants: "4",
      phrase: "Where a smart answer wont get you fired. (iykyk)",
      rules:
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-QUIZITE.png',floor: 'SECOND FLOOR'),
  Eventss(
      name: "X-GAANA",
      about: "ANTAKSHARI",
      category: "OFF-STAGE",
      ...
      rules:
      """Antakshari is a spoken parlour game played in India. Each contestant sings the first verse of a song that begins with the consonant of Hindi alphabet on which the previous contestant's song ended. There are many other interesting ways to play.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-GAANA.png',floor: 'FIRST FLOOR'),
  Eventss(
      name: "X-SPLASH",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-SPLASH.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-TRIAL",
      about: "MOOT COURT",
      category: "OFF-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-TRIAL.png',floor: 'FIRST FLOOR'),
  Eventss(
      name: "X-30",
      ...
      rules:
      """It tests the person's fluency and linguistic ability as one gets almost no time to prepare and has to start speaking as soon as the topic is provided. Even a slight pause may lead to deduction of points.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-30.png',floor: 'FIRST FLOOR'),
  Eventss(
      name: "X-CALIBRE",
      about: "DEBATE",
      category: "OFF-STAGE",
      ...
      rules:
      """Knowledge increases on being shared. Share your arguments and let the judges decide which is more convincing.
\n1.  Participants: 2 for Stage, 3 for Semi-Finals and Finals

2. Group Stage Rules:

      All schools will be divided into 2 pools.

      2 teammates per school - 1 for the motion, 1 against.

      Debate Rules:- Standard Oxford

      2 + 1 minute speech, 1 rebuttal.

      45 mins preparation time will be provided.

      Pools to be decided via lottery.

      2 teams from each pool will qualify for the Semi-Finals.

 
3. Semi Finals/Finals
      The debate will follow Asian Parliamentary Debate rules.

      Proposition Team Structure:- Prime Minister, Deputy Prime Minister, Government Whip

      Opposition Team Structure:- Leader Of Opposition, Deputy Leader Of Opposition, Opposition Whip

      Timings:-
            Semi Finals: - 2 + 1 minute speech, 2 minute reply speech

            Finals: - 4 + 1 minute speech, 3 minute reply speech

      Reply speech to be given by anyone except the Whip.
""",
      link: "images/X-CALIBRE.png",
      guidelines: """Venue: St. Xavier's Collegiate School, Kolkata
    \nDate: 14th, 15th and 16th October, 2022
\n\n1. Each school must be represented by two students who must be
present throughout the fest.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-CALIBRE.png',floor: 'FIRST FLOOR'),
  Eventss(
      name: "X-BID",
      about: "IPL AUCTION",
      category: "OFF-STAGE",
      ...
      participants: "2",
      phrase:
      "What is the similarity between Sidharth Malhotra and Shikhar Dhawan? They have both been dropped.",
      rules:
      """The IPL auction is a yearly event conducted by BCCI to auction the cricket players to various franchises.This will be a simulation to the same where a team has to be built and it has to be further pitched to the judges for value and sponsors.
\n1. Participants: 2
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-BID.png',floor: 'SECOND FLOOR'),
  Eventss(
      name: "X-HUNT",
      about: "TREASURE HUNT",
      category: "OFF-STAGE",
      ...
      phrase: "Find the X.",
      rules:
      """A treasure hunt is a game in which the organisers prepare a list defining specific items, which the participants seek to gather or complete all items on the list, usually without purchasing them.
\n1. No. of participants: 2
\n2. Each school can employ the use of the school reps assigned to them to explore the school campus for clues.
""",
      link: "images/X-HUNT.png",
      guidelines: """Venue: St. Xavier's Collegiate School, Kolkata
    \nDate: 14th, 15th and 16th October, 2022
\n\n1. Each school must be represented by two students who must be
present throughout the fest.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-HUNT.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-CODE",
      about: "HACKATHON",
      category: "OFF-STAGE",
      ...
      participants: "2",
      phrase:
      "“If the outside is so good, why has man spent thousands of years trying to perfect the inside?”",
      rules:
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-CODE.png',floor: 'SECOND FLOOR'),
  Eventss(
      name: "X-PIXEL",
      about: "PHOTOGRAPHY",
      category: "OFF-STAGE",
      ...
      participants: "2",
      phrase:
      "Photography is an art where Earth is the canvas. It is limitless and the skill of a photographer brings forth its beauty.",
      rules: """
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-PIXEL.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-MONTAGE",
      about: "VLOGGING",
      category: "OFF-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-MONTAGE.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-BET",
      ...
      day: "Pre-Fest",
      time: "",
      participants: "School Representatives",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-BET.png',floor: 'ONLINE',),
];
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-60.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-ABHINOY",
      about: "BENGALI PLAY",
      category: "ON-STAGE",
...
\nTheme- সমজজীবনে সামাজিক মাধ্যমের এভাব
\nLanguage: Bengali
\n1. Participants: 9+1(including script writer)
\n2. Duration : 12+3 minutes
\n3. Exceeding the time limit will result in negative marking.
\n4. The host school will provide microphones, on-collar microphones and on
stage equipments as per availability.
\n5. Participants have to bring their own props and costumes for the play
(decent clothing).
\n6. The host school does not bear the responsibility of any items brought by
the participants
in case it gets lost.
\n7. Using vulgar language or any profanity will lead to immediate
disqualification.
\n8. There should be no direct mention of any political figure or entity, dead
or alive.
\n9. The decisions of the judges and the organisers will be considered final
and binding in all cases.
\n10. Plagiarised ideas will not be entertained
""",
      link: "images/X-ABHINOY.png",
      guidelines: """Venue: St. Xavier's Collegiate School, Kolkata
    \nDate: 14th, 15th and 16th October, 2022
\n\n1. Each school must be represented by two students who must be
present throughout the fest.
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-ABHINOY.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-ACT",
      about: "AD-SPOOF",
      category: "ON-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-ACT.png',floor: 'FIRST FLOOR'),
  Eventss(
      name: "X-DROP",
      about: "RAP BATTLE & BEATBOXING",
      category: "ON-STAGE",
      location: "Primary School Auditorium",
      day: "1",
      time: "1:30",
      participants: "1+1",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-DROP.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-RHYME",
      about: "SLAM POETRY",
      category: "ON-STAGE",
      ...
      participants: "1",
      phrase:
      "People don’t remember the characters, they only remember the poets.",
      rules:
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-RYHME.png',floor: 'SECOND FLOOR'),
  Eventss(
      name: "X-RAGA",
      about: "EASTERN MUSIC",
      category: "ON-STAGE",
      ...
      rules:
      """Eastern classical music is essentially homophonic meaning that it focuses on melodies created by using an arrangement of notes. Its magic is experienced through the use of different melodies created within the structure of ragas.
\n1. Participants: 6 + 4
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-RAGA.png',floor: 'FIRST FLOOR'),
  Eventss(
      name: "X-HOP",
      about: "DANCE FACE OFF",
      category: "ON-STAGE",
      location: "Primary School Gymnasium",
      day: "1",
      time: "12:30",
      participants: "1+1",
      phrase: "When in doubt, dance it out!",
      rules:
      """Dance Face-Off involves two individual dancers competing against each other in one-on-one battles.It is a competition, or a round in a competition, in which a number of dancers compete against each other until a winner is declared..
\n1. Participants: 1 + 1
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-HOP.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-TRAVANGANCE",
      about: "WESTERN DANCE",
      category: "ON-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-TRAVAGANCE.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-ACOUSTIC",
      about: "WESTERN MUSIC",
      category: "ON-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-ACOUSTIC.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-PUN",
      about: "STAND UP",
      category: "ON-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-PUN.png',floor: 'GROUND FLOOR'),
  Eventss(
      name: "X-VOGUE",
      about: "FASHION SHOW",
      category: "ON-STAGE",
...
participating in their respective events.
\n9. Rights to admission are reserved.""",
    mapLink: 'lib/Event_Location/X-VOGUE.png',floor: 'GROUND FLOOR'),
];