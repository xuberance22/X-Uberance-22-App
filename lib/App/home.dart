...
import 'package:xuberance22_app/leaderboard.dart';
import '../App/events_map_page.dart';
import '../App/schools.dart';
import '../App/sponsors.dart';
                      ...
                      ElevatedButton(
                          ...
                          child: Padding(
                            ...
                            child: Text("LEADERBOARD", style: TextStyle(
                              fontFamily: 'Xavier2',
                              fontSize: 0.03625 * MediaQuery.of(context).size.width,
                              letterSpacing:
                              0.00075 * MediaQuery.of(context).size.width,
                            ),),
                          )),
