...
class Department2 extends StatefulWidget {
  ...
  final String name1;
  const Department2(
      {Key? key, required this.dep, required this.name1, })
      : super(key: key);

  @override
  // ignore: no_logic_in_create_state
  State<Department2> createState() =>
      _Department2State(dep: dep, name1: name1, );
}
...
class _Department2State extends State<Department2> {
  ...
  String name1;
  _Department2State(
      {required this.dep, required this.name1,});
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Center(
...
class Department3 extends StatefulWidget {
  ...
  final String name3;
  const Department3(
      {Key? key, required this.dep, required this.name1, required this.name2,required this.name3})
      : super(key: key);
...
class _Department3State extends State<Department3> {
  ...
  String name3;
  _Department3State(
      {required this.dep, required this.name1, required this.name2, required this.name3});
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Center(
...
//                             designation: "TECHNICAL  DIRECTOR",
//                             about:
//                             """He has been a part of all the events where even a slight tech is involved from preparing songs for Fashion Show to preparing the background video for dance which led him to being on the board of the newest and one of the most inclusive clubs of St. Xavier’s, X-Code (Computer Club). He is the only one visible everywhere, especially if you sit behind him in class.
// Apart from all this he might be the only one brave enough to wear jeans to school and still show up to the Principal’s office casually.
// Some people call him potato not because he looks like one but because he is one.
// A human cushion and the Charles Babbage of Xaviers, talking no sense maximum number of the times but still managing to be one of the smartest chaps in his batch.
// PS: If you can’t find him, he’s probably editing something on his computer
...
//                             name: "ADITYA  SHREEDHARAN",
//                             designation: "TREASURER",
//                             about: """ From rejecting Science to being a self-proclaimed financial expert, Aditiya has found himself to be the co-treasurer of the fest and a board member, of one of the most prestigious clubs in Xaviers, X-Commericia.
// Apart from being an auspicious and upbeat person, to a suprisingly good pianist, Adi is a person who always backs and upholds others ( maybe because of how tall he is ), but never stops bragging about his appearance or random advice. Competing in various business competitions and fests, Adi has proven to be a deserving member of the core. We just hope he puts in as much effort as he does in this instagram DMs XD
//
// PS: if you can’t find him, he is probably at some house party.""",
//                             link: "teamPhoto/ADITYA_SREEDHARAN.png"),
